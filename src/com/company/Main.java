...
public class Main{
    ...
    public static void main(String args[]){
        ...
        Date birthday = new Date(87, 4, 20);
        System.out.printf("Date is dd/mm/yy format %td/%tm/%ty %n", birthday, birthday, birthday);

        // date as July 25, 2012, difference between %td and %te is that
        // %td use leading zero while %te doesn't
        System.out.printf("My birthday is %tB %te, %tY %n", birthday, birthday, birthday, birthday);
